...
public class CameraConfig {
     ...
     * @param cameraToRobotXMeters the x distance from the robot ceneter to the center of the camera in meters
     * @param cameraToRobotYMeters the y distance from the robot ceneter to the center of the camera in meters
     * @param cameraToRobotZMeters the z distance from the robot ceneter to the center of the camera in meters
     * @param cameraPitchRadians the pitch of the camera in radians. Be careful with direction of rotation
     */
    public CameraConfig(String cameraName, double cameraToRobotXMeters, double cameraToRobotYMeters, double cameraToRobotZMeters, double cameraPitchRadians, double cameraYawRadians, double cameraRollRadians) {
